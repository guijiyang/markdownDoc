...
|Ctrl+Shift+Tab|快速打开编辑器组中最近使用的编辑器|
...
|Ctrl+K Ctrl+D|将最后选中的对象光标移动到下一个相同的对象|

### 多光标选择
|快捷键|作用|
|:-:|:-|
|Shift+Alt+Up(Down)|向上(下)插入光标|
|Ctrl+L|选中当前行|
|Ctrl+Shift+L|选中当前对象和所有匹配对象|
|Ctrl+F2|选中当前词和所有匹配词|
...
|Ctrl+K Left(Right)|将当前编辑器组向前(后)移动|
